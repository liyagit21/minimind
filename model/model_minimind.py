...
class MoEGate(nn.Module):
    ...
    def adaptive_threshold_init(self, strategy='uniform'):
        ...
        if strategy == 'uniform':
            # 均匀分布初始化
            nn.init.uniform_(self.expert_thresholds, 0, 0.5)
        elif strategy == 'expert_capacity_based':
            # 基于期望专家容量的初始化
            target_sparsity = 0.5  # 目标稀疏度 0.3
